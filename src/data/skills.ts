...
export const skillRows: SkillRow[] = [
  ...
  {
    name: 'C / C++',
    desc: '42경산에서 Unix 프로세스 · 메모리 관리를 밑바닥부터 구현 — 프레임워크 아래층을 이해하는 눈.',
  },
]

export const alsoLine =
  'AWS EC2 · Nginx / Python · FastAPI / Electron · PyInstaller · Inno Setup / Docker / Git / MySQL / HTML5 · JavaScript / React · Vue.js'

export const highlightLine =
  '로컬 AI 모델 운용(Whisper · NLLB, PyTorch 계열) — 클라우드 운영(AWS EC2, 현재 운영 중) — 빌드 자동화(3단계 패키징 파이프라인)'
