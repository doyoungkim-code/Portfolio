...
export const project1 = {
  ...
  demo: {
    ...
    /* 챕터 전환 시 휴대폰 전체를 먼저 보여준 뒤, 기능이 일어나는 부분으로 확대 (논리 좌표, 약 1.47배) */
    focus: {
      0: { x: 70, y: 250, w: 300, h: 440 },
      1: { x: 70, y: 30, w: 300, h: 470 },
      2: { x: 70, y: 120, w: 300, h: 470 },
      3: { x: 70, y: 120, w: 300, h: 470 },
      4: { x: 70, y: 140, w: 300, h: 470 },
      5: { x: 70, y: 10, w: 300, h: 420 },
      6: { x: 70, y: 170, w: 300, h: 520 }, /* 채팅방: 메시지 + 입력창 함께 */
      7: { x: 70, y: 30, w: 300, h: 470 },
